...
// Cek validitas konfigurasi - hanya perlu URL dan key yang valid
...
if (!isValid) {
  ...
  console.warn("Pastikan anda memiliki .env file dengan VITE_SUPABASE_URL dan VITE_SUPABASE_ANON_KEY");
} else {
