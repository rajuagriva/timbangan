...
import { 
  AreaChart, Area, BarChart, Bar, XAxis, YAxis, CartesianGrid, ResponsiveContainer, Cell
} from 'recharts';
import { 
  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-6 left-0 w-full text-center">
          <p className="text-[10px] text-slate-300 uppercase tracking-widest">Confidential Document • Internal Use Only</p>
      </div>
